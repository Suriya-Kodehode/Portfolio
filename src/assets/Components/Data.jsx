...
export const projects = [
    {
        ...
        imageUrl: '/Portfolio-forsettelse-oppgave/images/project_sample1.svg',
        backgroundColor: '#894141',
        url: 'https://suriya-kodehode.github.io/ViteNPM-prosjekt/',
    },
    {
        title: 'Restaurantmenyen',
        imageUrl: '/Portfolio-forsettelse-oppgave/images/project_sample2.svg',
...
export const linkBox = [
    {
        text: 'Github',
        iconLight: '/Portfolio-forsettelse-oppgave/images/Icon=GitIcon, Color=White.svg',
        iconDark: '/Portfolio-forsettelse-oppgave/images/Icon=GitIcon, Color=Black.svg',
    ...
    {
        text: 'Last ned CV',
        iconLight: '/Portfolio-forsettelse-oppgave/images/Icon=Download, Color=White.svg',
